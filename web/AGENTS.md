...
Rules for any AI agent (Claude Code, Cursor, Copilot, etc.) working in this folder. These exist because LLM training data lags behind the actual stack used here.
