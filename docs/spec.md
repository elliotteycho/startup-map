...
Status as of May 14, 2026, inferred from repo commits and file state. Checked items have clear evidence of completion in the repo; unchecked items have no evidence of work yet. Verify against your own memory and adjust.
...
- [x] Write README and decisions log
